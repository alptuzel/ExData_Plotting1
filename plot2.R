...
## as.POSIXct(consumption_feb_1_2_dt$Date_Time[15], "%Y-%m-%d %H:%M:%S")
##with(consumption_feb_1_2_dt, plot( as.POSIXct(Date_Time, "%Y-%m-%d %H:%M:%S") , Global_active_power, type="l"))
